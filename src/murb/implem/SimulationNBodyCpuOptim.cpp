...
SimulationNBodyCpuOptim::SimulationNBodyCpuOptim(const unsigned long nBodies, const std::string &scheme, const float soft,
...
void SimulationNBodyCpuOptim::initIteration()
{
...
void SimulationNBodyCpuOptim::computeBodiesAcceleration()
{
...
void SimulationNBodyCpuOptim::computeOneIteration()
{
    this->initIteration();
